...
<title><bean:message key="org.lingcloud.molva.xmm.monitor.monitorOverview" />&nbsp;- <bean:message key="org.lingcloud.molva.lingcloud" /></title>
</head>

<body onload="showStatisticsMonitorPanel('<%=basePath%>');">
