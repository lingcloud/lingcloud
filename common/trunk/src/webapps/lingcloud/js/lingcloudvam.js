...
//    str += "<tr><td>\u683C\u5F0F:&nbsp;</td><td><select name=\"format\"><option value=\"raw\">raw</option><option value=\"qcow\">qcow</option><option value=\"vmdk\">vmdk</option></select></td></tr>";
    ...
    str += "<tr><td>"+lingcloud.Appliance.newAppliance.application+":&nbsp;</td><td><input type=\"text\" id=\"oneapp\" /><a href='javascript:addValue(\"oneapp\",\"apps\");'>+</a><font color='red'>("+lingcloud.Appliance.newAppliance.clickToAdd+")</font></td></tr><tr><td></td><td><input type='text' readonly='true' id='apps' name='app'><a href='javascript:clearValues(\"apps\");'>" + lingcloud.tip.clear + " </a></td></tr>";
//    str += "<tr><td>\u542F\u52A8\u52A0\u8F7D\u7A0B\u5E8F:&nbsp;</td><td><select name=\"loader\"><option value=\"hvm\">hvm</option><option value=\"pygrub\">pygrub</option></select></td></tr>";
    ...
    str += "<tr><td>"+lingcloud.Appliance.newAppliance.lang+":&nbsp;</td><td><select id=\"lang\"><option>Chinese(simplified)</option><option>Chinese(traditional)</option><option>English</option><option>French</option><option>German</option><option>Italian</option><option>Japanese</option><option>Korean</option><option>Russian</option><option>Spanish</option><option>Other</option></select><a href='javascript:addValue(\"lang\",\"langs\");'>+</a><font color='red'>("+lingcloud.Appliance.newAppliance.clickToAdd+")</font></td></tr><tr><td></td><td><input type='text' readonly='true' id='langs' name='language'><a href='javascript:clearValues(\"langs\");'>" + lingcloud.tip.clear + " </a></td></tr>";
...
showDialogForModifyAppliance = function (basePath, guid) {
    ...
    str += "<tr><td>"+lingcloud.Appliance.modifyAppliance.application+":&nbsp;</td><td><input type=\"text\" id=\"oneapp\" /><a href='javascript:addValue(\"oneapp\",\"apps\");'>+</a><font color='red'>("+lingcloud.Appliance.newAppliance.clickToAdd+")</font></td></tr><tr><td></td><td><input type='text' readonly='true' id='apps' name='app'><a href='javascript:clearValues(\"apps\");'>" + lingcloud.tip.clear + " </a></td></tr>";
...
showDialogForCreateVirtualDisc = function (basePath) {
    ...
    str += "<tr><td>"+lingcloud.Appliance.newVirtualDisc.application+":&nbsp;</td><td><input type=\"text\" id=\"oneapp\" /><a href='javascript:addValue(\"oneapp\",\"apps\");'>+</a><font color='red'>("+lingcloud.Appliance.newAppliance.clickToAdd+")</font></td></tr><tr><td></td><td><input type='text' readonly='true' id='apps' name='app'><a href='javascript:clearValues(\"apps\");'>" + lingcloud.tip.clear + " </a></td></tr>";
    str += "</tbody>";
    str += "</table></form>\n";
...
showDialogForModifyVirtualDisc = function (basePath, guid) {
    ...
    str += "<tr><td>"+lingcloud.Appliance.modifyVirtualDisc.application+":&nbsp;</td><td><input type=\"text\" id=\"oneapp\" /><a href='javascript:addValue(\"oneapp\",\"apps\");'>+</a><font color='red'>("+lingcloud.Appliance.newAppliance.clickToAdd+")</font></td></tr><tr><td></td><td><input type='text' readonly='true' id='apps' name='app'><a href='javascript:clearValues(\"apps\");'>" + lingcloud.tip.clear + " </a></td></tr>";
    str += "</tbody>";
    str += "</table></form>\n";
...
//    str += "<tr><td>\u683C\u5F0F:&nbsp;</td><td><select name=\"format\"><option value=\"raw\">raw</option><option value=\"qcow\">qcow</option><option value=\"vmdk\">vmdk</option></select></td></tr>";
    str += "<tr><td>"+lingcloud.Appliance.saveAppliance.application+":&nbsp;</td><td><input type=\"text\" id=\"oneapp\" /><a href='javascript:addValue(\"oneapp\",\"apps\");'>+</a><font color='red'>("+lingcloud.Appliance.newAppliance.clickToAdd+")</font></td></tr><tr><td></td><td><input type='text' readonly='true' id='apps' name='app'><a href='javascript:clearValues(\"apps\");'>" + lingcloud.tip.clear + " </a></td></tr>";
    ...
    str += "<tr><td>"+lingcloud.Appliance.saveAppliance.lang+":&nbsp;</td><td><select id=\"lang\"><option>Chinese(simplified)</option><option>Chinese(traditional)</option><option>English</option><option>French</option><option>German</option><option>Italian</option><option>Japanese</option><option>Korean</option><option>Russian</option><option>Spanish</option><option>Other</option></select><a href='javascript:addValue(\"lang\",\"langs\");'>+</a><font color='red'>("+lingcloud.Appliance.newAppliance.clickToAdd+")</font></td></tr><tr><td></td><td><input type='text' readonly='true' id='langs' name='language'><a href='javascript:clearValues(\"langs\");'>" + lingcloud.tip.clear + " </a></td></tr>";
    str += "<tbody id='userpass' style='DISPLAY:none'>";
