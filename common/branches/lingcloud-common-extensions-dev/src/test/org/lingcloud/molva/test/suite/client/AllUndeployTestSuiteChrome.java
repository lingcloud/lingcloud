/*
 *  @(#)AllUndeployTestSuiteChrome.java 2011-6-26
 *
 ...
 * 
 */
public class AllUndeployTestSuiteChrome {
	
    public static Test suite() {

    	AllUndeployTestSuiteImpl ts = new AllUndeployTestSuiteImpl(TestConstants.Browser.CHROME);
